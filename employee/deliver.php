                                                  ...
                                                  echo '<script type="text/javascript"> alert("Item Not Picked Up Yet") </script>';
                                                    ...
                                                    else if($rows['status']==1)
                                                    {
                                                        ...
                                                        {    
                                                                ...
                                                                if($sent)
                                                                    {
                                                                        echo '<script type="text/javascript"> alert("Item Delivered Successfully, email sent") </script>';               
                                                                    }
                                                                else
                                                                {
                                                                    echo '<script type="text/javascript"> alert("Item Delivered Successfully,error: email not sent") </script>';
                                                                }
