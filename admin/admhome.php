...
<div id="container">
	...
	<form class="myform" action="admhome.php" method="post">
		...
		<br>
		<br>
		<a href="browsec.php"><input type="button" id="register-button" value="Customers / Drivers Details"></a>
		<br>
		<br>
		<a href="consview.php"><input type="button" id="register-button" value="Consignment Lists"></a>
		<br>
		<br>
